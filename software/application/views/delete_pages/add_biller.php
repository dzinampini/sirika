<?php include('header.php'); ?>
 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card-body">
        <form action="biller_add" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            <input class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" name="company" required  placeholder="Biller Name">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Invoice &amp; Quotation Footer Preferences</label>
            <textarea name="invoice" type="text" class="form-control" id="editor" required placeholder="Invoice Footer Preference"></textarea>
          </div>
          <div class="form-group">
            <label>Receipt Footer Preferences</label>
            <textarea name="receipt" type="text" class="form-control" id="editor" required placeholder="Receipt Footer Preference"></textarea>
          </div>

          <button class="btn btn-primary btn-block">Add Biller</button>
        </form>
      </div>
    </div>
