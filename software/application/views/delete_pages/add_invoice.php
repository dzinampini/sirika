<?php include('header.php'); ?>
 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card-body">
        <form action="invoice_add" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <select name="reccurence" class="form-control" required>
              <option value="">Select Reccurence</option>
